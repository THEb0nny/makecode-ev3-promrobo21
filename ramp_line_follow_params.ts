namespace params {
     ...
     * @param newMinStartV начальная скорость движения, eg: 30
     * @param newMaxV максимальная скорость движения, eg: 50
     * @param newMinFihishV конечная скорость движения, eg: 30
     ...
     * @param newStartV начальная скорость движения, eg: 30
     * @param newMaxV максимальная скорость движения, eg: 50
     * @param newFinishV конечная скорость движения, eg: 30
     */
