namespace levelings {
    ...
    export function lineAlignment(lineLocation: VerticalLineLocation, regulatorTime: number, params?: params.LineAlignment, debug: boolean = false) {
        ...
        pidLeftSideLineAlignment.setPoint(0); // Установить нулевую уставку регулятору
        pidRightSideLineAlignment.setPoint(0); // Установить нулевую уставку регулятору
    ...
    export function linePositioning(regTime: number, params?: params.LinePositioning, debug: boolean = false) {
        ...
        pidLinePositioning.setPoint(0); // Установить нулевую уставку регулятору
